...
const DATA = [
    {
        ...
        sources: [
            'https://www.youtube.com/watch?v=FoMlSB6ftQg&list=PLIbLfYSA8ACNYCOaDWmj6EA1F1uS-pyVL&index=1&ab_channel=UnderseaStockFootage',
        ],
    ...
    return (
        <View
            style={[
                styles.item,
                {
                    backgroundColor: props.index % 2 === 0 ? 'red' : 'green',
                    flex: 1,
                },
            ]}
        >
